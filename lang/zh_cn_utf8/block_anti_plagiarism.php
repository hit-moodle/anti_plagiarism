...
$string['describeduplication'] = 'Duplication是<a href=\"http://ir.hit.edu.cn/\">哈尔滨工业大学信息检索研究中心</a>开发的一个中文抄袭检测系统，支持文本、doc和pdf格式的文档。';
$string['describeextnames'] = '被评判文件的扩展名(用空格分隔多个)';
$string['describejudger'] = '选择评判引擎';
$string['describemoss'] = '<a href=\"http://theory.stanford.edu/~aiken/moss/\">Moss</a> (Measure Of Software Similarity) 是一个程序相似性自动检测系统。';
$string['describesensitivity'] = '灵敏度';
$string['describetype'] = '选择编程语言';
$string['describeunrar'] = '本插件可以自动解开rar压缩的文件。如果您不需要此功能，请将本项留空。';
$string['done'] = '完成。';
